...
import HistoryScreenDesktop from './HistoryScreenDesktop';
...
export default function HistoryScreen() {
  ...
  if (isDesktop) {
    return (
      <HistoryScreenDesktop
        mode={mode}
        onModeChange={(m) => { setMode(m); setCursor(getTodayString()); }}
        ...
        sessions={sessions}
        stats={stats}
        onSessionPress={(id) => navigation.navigate('SessionDetail', { sessionId: id })}
